...
impl From<&str> for Expr {
    fn from(s: &str) -> Self {
        lit(NoirType::String(s.to_string()))
    }
}
...
impl Add<i32> for Expr {
    ...
    fn add(self, rhs: i32) -> Self::Output {
        binary_expr(self, BinaryOp::Plus, lit(NoirType::Int(rhs)))
    }
}
...
impl Sub<f32> for Expr {
    ...
    fn sub(self, rhs: f32) -> Self::Output {
        binary_expr(self, BinaryOp::Minus, lit(NoirType::Float(rhs)))
    }
}
