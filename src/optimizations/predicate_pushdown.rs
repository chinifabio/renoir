...
use crate::dsl::expressions::{BinaryOp, Expr};
    ...
    fn pushdown(
        ...
        match plan {
            ...
            LogicPlan::Filter { predicate, input } => {
                ...
                let upstream_predicates: Vec<_> = accumulator
                    .iter_mut()
            ...
            LogicPlan::Join {
                ...
                let left_header_len = input_left.get_schema().len();
...
pub mod test {
    ...
    use crate::datatypes::NoirTypeKind;
    use crate::dsl::expressions::*;
    use crate::optimizations::logical_plan::{JoinType, LogicPlan};
    use crate::optimizations::optimizer::OptimizationRule;
    use crate::optimizations::predicate_pushdown::{PredicatePushdown, PredicateWrapper};
    ...
    fn create_scan() -> LogicPlan {
        LogicPlan::TableScan {
            ...
            predicate: None,
            projections: None,
            schema: Some(Schema::same_type(10, NoirTypeKind::Int)),
        }
    }
